                  ...
                  <tr key={operation.id} className="operation-row">
                    ...
                    <td className="actions-cell">
                      <div className="action-buttons">
                        <button className="btn-action btn-edit" title="ویرایش" onClick={() => handleEditClick(operation)}>
                          <FaEdit />
                        </button>
                        <button className="btn-action btn-delete" title="حذف" onClick={() => handleDeleteClick(operation)}>
                          <FaTrash />
                        </button>
                      </div>
                    </td>
